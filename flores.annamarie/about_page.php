...
<div class="container">
		...
		<article id="article4" class="article card soft">
			...
			<div class="article-body">
				<p class="articleImg"><img class="company_image" src="img/heroFamilyBanner.jpg" alt="Farmer Handshake"> 
					<br>
					<h2>Our Story</h2>
				Prospect Market was established in 2011 and is continuing to grow and expand! We offer produce from multiple sources around our local community so we can provide a wide selection of food and items. </p>
